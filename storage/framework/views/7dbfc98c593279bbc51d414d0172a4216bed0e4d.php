    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.adminPanelSetting.index')); ?>" class="nav-link">
...
<?php /**PATH C:\laragon\www\sales\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>