...
<head>
    ...
    <link href="<?php echo e(asset('assets/admin/fonts/SansPro/SansPro.min.css')); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="text-bg-danger p-3"><?php echo e($message); ?></span>
                <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="text-bg-warning p-3"><?php echo e($message); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php /**PATH C:\xampp\htdocs\sales\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>