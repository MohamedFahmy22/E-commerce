                    ...
                    @if (@isset($data) && !@empty($data))
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td >
                                    <div class="image">
                                        <img style="width: 50px; height: 50px" src="{{ asset('assets/admin/uploads').'/'.$data['photo'] }}"  alt="لوجو الشركة">
                                    </div>
                            ...
                            <tr>
                                <td>العمليات</td>
                                <td>
                                    <a href="{{ route('admin.adminPanelSetting.edit') }}" class="btn btn-success">تعديل</a>
